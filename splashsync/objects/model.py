...
from .core import SalesRelations, CompanyRelations


class OdooObject(ListsHelper, BinaryFields, BaseObject, SimpleFields, BasicFields, SalesRelations, CompanyRelations):
